...
| [Vim](http://www.vim.org/) | 沒有圖形界面的環境下我是 Vim 派。 | 🆓 |

## 開發工具

| 名稱 | 說明 |  💲  |
| ---- | ---- | :--: |
| [Git](https://git-scm.com/) | 受歡迎的版本控制系統。 | 🆓 |
| [Docker](https://www.docker.com/) | 輕量化的 container 平台，用來快速部屬開發環境。 | 🆓 |
...
| [FileZilla](https://filezilla-project.org/) | 老字號的 FTP 傳檔工具。 | 🆓 |
...
| [SpeedyFox](https://www.crystalidea.com/speedyfox) | 最佳化 Firefox 和 Chrome 瀏覽器的資料庫檔案。 | 🆓 |
...
| [Google Fonts](https://fonts.google.com/) | Google 提供的 Webfont 服務。 |
| [justfont就是字](https://www.justfont.com/) | 中文的 Webfont 服務，也在推廣中文字型知識。 |
